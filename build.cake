...
var isRepository = StringComparer.OrdinalIgnoreCase.Equals("sushihangover/RealmThread", AppVeyor.Environment.Repository.Name);
    ...
    .Does (() =>
{
    ...
    build("SushiHangover.RealmThread.sln");
});
...
{
    buildThisApp(
        "./src/RealmThread.Tests.iOS/RealmThread.Tests.iOS.csproj",
        "UnitTesting",
        "Rebuild"    
    );
    unitTestApp(
        "com.sushhangover.realmthread-tests-ios",
        "./artifacts/RealmThread.Tests.iOS.app"
    );
});
